...
TEMPLATES: dict[str, dict[str, str]] = {
    ...
    "human": {
        ...
        "destroyed":              "{arg} was killed or did not survive the event.",
        "existed_before":         "{arg} was alive before the event.",
        "existed_during":         "{arg} was alive during the event.",
    ...
    "organization": {
        ...
        "destroyed":              "{arg} was dissolved or ceased to exist as a result of the event.",
        "existed_before":         "{arg} was operating before the event.",
        "existed_during":         "{arg} was operating during the event.",
        "location_of_event":      "The event took place at {arg}'s location.",
    },
    "physical_object": {
        "change_of_location":     "{arg} moved to a different location during the event.",
        ...
        "destroyed":              "{arg} was broken, destroyed, or otherwise ceased to exist during the event.",
        "existed_before":         "{arg} was present before the event.",
        "existed_during":         "{arg} was present during the event.",
        "location_of_event":      "The event took place at the location of {arg}.",
    },
    "location": {
        ...
        "existed_before":         "{arg} existed before the event.",
        "existed_after":          "{arg} existed after the event.",
        "awareness":              "Participants at {arg} were aware of what was happening during the event.",
        ...
        "destroyed":              "{arg} was destroyed and ceased to exist as a place during the event.",
    },
    "abstract_concept": {
        "awareness":              "The event involved conscious awareness of {arg}.",
        ...
        "destroyed":              "{arg} was eliminated, ended, or nullified by the event.",
        "existed_before":         "{arg} was in use or relevant before the event.",
        "existed_during":         "{arg} was relevant or active during the event.",
    },
    "quantity_or_measure": {
        ...
        "awareness":              "A participant became aware of {arg} during the event.",
        ...
        "destroyed":              "{arg} was depleted or reduced to nothing during the event.",
        "existed_before":         "{arg} had a value before the event.",
        "existed_during":         "{arg} had a value during the event.",
    },
}
